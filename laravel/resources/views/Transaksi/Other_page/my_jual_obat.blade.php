...
<div id="wrapper">
	...
	<div class="form-container">
		<form action="/views/my_jual_obat.php" method="post" name="frm_work" id="frm_work">
				...
				<tr>
					<td>
						<div>
							...
							<input id="no_penjualan" name="no_penjualan" type="hidden" value="1711001"/>
...
<option value="DK020" >dr. Renata Mayangsari, spKK</option>
		...
		<fieldset>
			...
			<table border="0" cellspacing="1" cellpadding="2" bgcolor="#000000"  align="center" width="70%">
				<tr bgcolor="#E6E6E6">
					...
					<!--<th align="center" width="10%">Voucher</th>-->
				...
				<tr bgcolor="#ffffff">
					...
					<td width="5%" align="center"><input id="disc" name="disc" type="text" value="0" size="5%" onBlur="getCalculate();" onKeyPress="return numbersonly(this, event)" ></td>
					<!--<td width="10%" align="center"><input id="voucher" name="voucher" type="text" value="0" size="10%" onBlur="getCalculate();" onKeyPress="return numbersonly(this, event)" ></td>-->
					<td width="5%" align="center"><input id="total" name="total" type="text" value="0" size="10%" readonly></td>		
		...
		<fieldset>
			...
			<div>
				...
				<input id="tot_voucher" name="tot_voucher" type="text" value="0" size="20" onBlur="getCalculateAll();"/>
			</div>
			<div>
				<label for="">Pajak (%)<em>*</em></label> 
				<input id="tot_vat" name="tot_vat" type="text" value="0" size="20"  onBlur="getCalculateAll();" />
			</div>
			<div>
...
<script type="text/javascript">
	...
	function getCalculateAll()
	{
		var total = parseFloat(shortcut.tot_ktr.value) - parseFloat(shortcut.tot_disc.value) - parseFloat(shortcut.tot_voucher.value);
	...
	function genDetail(act) {
		...
		*/
		...
		var xdis = shortcut.disc.value;
		//var xvou = shortcut.voucher.value;
		var url = 'gen_penjualan_detail.php?act=add&xnp='+xnp+'&xkd='+xkd+'&xqty='+xqty+'&xhrg='+xhrg+'&xdis='+xdis;
		//alert(url);
	...
	var answer=confirm("Apakah Anda yakin ingin menghapus ?");
		if (answer) {
			var url = 'gen_penjualan_detail.php?xkd='+xval+'&act='+xtipe;
			//alert(url);
			new Ajax.Request(url, {
				method: 'get',
				onSuccess: function(transport) {
	...
	function fget_grantotal() {
		var lbtxt ='';
		var url = 'ajax_control.php?m=cek_total_pen';
		//alert(url);
			...
			new Ajax.Request(url, {
				...
				onSuccess: function(transport) {
					...
					if (lbtxt!="") {
					  ...
					  //shortcut.tot_voucher.value=temp[3];
