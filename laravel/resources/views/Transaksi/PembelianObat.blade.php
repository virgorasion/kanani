@extends('Layouts.Master') @section('title') VIP | Pembelian Obat @endsection @section('content')
			...
			<div class="col-xs-12">
				<div class="box box-info">
					<div class="box-header">
						<!-- Start Header -->
						<a href="" onclick="window.open('{{url('/view_beli_obat/add')}}', 'newwindow'); return false;">
