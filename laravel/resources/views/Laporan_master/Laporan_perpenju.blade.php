...
<div class="container">
			<h4 class="title">Laporan <span style="color:#9FCB20">Perawatan & Penjualan</span></h4>

		<div class="box"> <!-- Start box -->
			<div class="box-header"> <!-- Start Header -->
			<button class="btn btn-success"  onclick="window.open('Laporan_perpenju_print.php', 'newwindow', 'width=300,height=250'); return false;">Print Laporan Perawatan & Penjualan</button>
            ...
            <div "col-sm-3 col-xs-5">
            <label for="kode_dokter">Kode Pasien</label>
            <input style="margin-left:2.4%;" id="kode_dokter" name="kode_dokter" type="text" size="20">
            </div><br>
			...
			<table class="table table-hover table-striped text-center table-border" id="datatable">
				<tr>
                <td><b>No</td></b>
				<td><b>No Transaksi</td></b>
				<td><b>Tanggal</td></b>
				<td><b>Tipe Transaksi</td></b>
                <td><b>Nama Pasien</td></b>
                <td><b>Nama Dokter</td></b>
                <td><b>Total</td></b>
				</tr>
				<tr>
                <td>1</td>
