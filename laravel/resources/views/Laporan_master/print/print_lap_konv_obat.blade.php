...
<form action="lap_absensi_export.php" method="post" name="bookform" id="frm_trans">
	...
	<table border="0" cellspacing="1" cellpadding="3"  width="80%" align="center">
		<tr bgcolor="#ffffff" >			
			<td align="center" valign="middle" ><h1 class="content_bold">Laporan Konversi Obat</h1>
			</td>
		</tr bgcolor="#ffffff">
		<tr bgcolor="#ffffff" >			
	...
	<table  border="0" cellspacing="1" cellpadding="2" width="80%" align="center" bgcolor="#400040">
          <tr bgcolor="#E6E6E6">
				...
				<th width="10%" class="content_bold"><h3>Tanggal</h3></th>
				<th width="15%" class="content_bold"><h3>Petugas</h3></th>
				<th class="content_bold"><h3>Nama Obat</h3></th>
				<th width="15%" class="content_bold"><h3>Qty Stok</h3></th>
				<th width="15%" class="content_bold"><h3>Qty Konversi</h3></th>
				<th width="15%" class="content_bold"><h3>Satuan</h3></th>
				<th width="15%" class="content_bold"><h3>Harga</h3></th>
    		</tr>
