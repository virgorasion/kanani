...
<title>Perawatan dan Penjualan Report</title>
...
<form action="lap_insentif_export.php" method="post" name="bookform" id="frm_trans">
	...
	<table width="100%" border="0" cellspacing="3" cellspacing='1'>
		<tr>
			<td width="50%">
				<table>
					<tr>
						<td><h1 class="content_bold">Laporan Perawatan dan Penjualan</h1></td> 
					</tr>
					<tr>
	...
	<table  border="0" cellspacing="1" cellpadding="2" bgcolor="#000000" width="100%" align="center" >
          <tr bgcolor="#E6E6E6">
				...
				<th class='content_bold'><h3>No Transaksi</h3></th>
				<th class='content_bold'><h3>Tanggal</h3></th>
				<th class='content_bold'><h3>Tipe Transaksi</h3></th>
				<th class='content_bold'><h3>Nama Pasien</h3></th>
				<th class='content_bold'><h3>Nama Dokter</h3></th>
