...
<form action="lap_perawatan_export.php" method="post" name="bookform" id="frm_trans">
	...
	<table width="100%" border="0" cellspacing="3" cellspacing='1'>
		<tr>
			<td width="50%">
				<table>
					<tr>
						<td><h1 class="content_bold">Laporan Perawatan</h1></td> 
					</tr>
					<tr>
	...
	<table  border="0" cellspacing="1" cellpadding="2" bgcolor="#000000" width="100%" align="center" >
          <tr bgcolor="#E6E6E6">
				...
				<th class='content_bold'><h3>No Perawatan</h3></th>
				<th class='content_bold'><h3>Kode Pasien</h3></th>
				<th class='content_bold'><h3>Nama Pasien</h3></th>
				<th class='content_bold'><h3>Tanggal</h3></th>
				<th class='content_bold'><h3>Jenis Rawat</h3></th>
				<th class='content_bold'><h3>Dokter</h3></th>
				<th class='content_bold'><h3>Perawat</h3></th>
				<th class='content_bold'><h3>Beutician</h3></th>
				<th class='content_bold'><h3>Sub Total</h3></th>
				<th class='content_bold'><h3>Diskon</h3></th>
				<th class='content_bold'><h3>Voucher</h3></th>
				<th class='content_bold'><h3>Total</h3></th>
				<th class='content_bold'><h3>Status</h3></th>
			</tr>
				<tr bgcolor="#ffffff">
