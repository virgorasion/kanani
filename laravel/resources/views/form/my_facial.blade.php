...
<option value="P1052" >NURUL HIDAYAH</option>
						...
						<div>
							<label for="">Jenis Facial<em>*</em></label>
...
<option value="2501" >vaksinasi HPV 3</option>
		...
		<table>
			<tr>
				<td><font size="3">Pilihan Upload Foto </font></td><td>:</td>
				<td>
			...
			<div id="box-upload">
				<table>	
					<div id="upload">
						<tr><input id="row" name="row" type="hidden" value="1">
							<td><b>Foto</b></td>
							<td><input type="file" id="filefoto_1" name="filefoto_1"/></td>
						</tr>
						<tr>
							<td><b>Keterangan</b></td>
							<td><input type="text" id="ket_1" name="ket_1"/></td>
						</tr>
					</div>
				</table>
		...
		<fieldset>
			<table align="center">
				<tr> 
					...
					<td><input type="button" value="Batal" onClick="cancelcek();"/></td>
				</tr>
			</table>
		</fieldset>
		</form>
